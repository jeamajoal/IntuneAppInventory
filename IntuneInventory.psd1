@{
    ...
    RootModule = 'IntuneInventory.psm1'
    ...
    CompanyName = 'Sound Physicians'

    # Copyright statement for this module
    Copyright = '(c) 2025 Sound Physicians. All rights reserved.'

    # Description of the functionality provided by this module
    Description = 'PowerShell module for inventorying Microsoft Intune applications, scripts, and remediations with SQLite backend storage and reporting capabilities.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('Intune', 'Microsoft365', 'DeviceManagement', 'Inventory', 'SQLite', 'Reporting')
            ...
            ReleaseNotes = 'Initial release of Intune Inventory module with SQLite backend storage.'
